...
<pre><code class="lang-js">ruby.add_methods_to_number_prototype();
    ...
    each(functions(<span class="hljs-keyword">this</span>.int), (method) =&gt; {
      <span class="hljs-built_in">Object</span>.defineProperty(
        <span class="hljs-built_in">Number</span>.prototype,
        method,
        { get: <span class="hljs-keyword">this</span>.int[method] }
      );
    });
  }</pre></div></div>
...
<pre><code class="lang-js">ruby.add_methods_to_string_prototype();
    ...
    each(functions(<span class="hljs-keyword">this</span>.str), (method) =&gt; {
      <span class="hljs-built_in">Object</span>.defineProperty(
        <span class="hljs-built_in">String</span>.prototype,
        method,
        { get: <span class="hljs-keyword">this</span>.str[method] }
      );
    });
  }</pre></div></div>
